...
export const strings = {
  ...
  "action.add-paint": "添加绘制",
  "action.add-paint.no-v1-layers.message":
    '此字形尚无 COLRv1 图层。请先使用颜色图层面板中的"v1"按钮初始化绘制图。',
  "action.add-paint.no-v1-layers.title": "没有 COLRv1 绘制图",
  ...
  "action.export-as.woff2": "网页字体 (*.woff2)",
  ...
  "color-graph.add-paint-layers": "在颜色图层面板中添加绘制图层",
  "color-graph.alpha": "透明度",
  "color-graph.backdrop-paint": "背景绘制",
  "color-graph.color-stops": "颜色停止点",
  "color-graph.composite": "合成",
  "color-graph.composite-mode": "合成模式",
  "color-graph.glyph": "字形",
  "color-graph.layers": "图层",
  "color-graph.linear-gradient": "线性渐变",
  "color-graph.no-glyph-selected": "未选择字形",
  "color-graph.no-paint-data": "没有 COLRv1 绘制数据",
  "color-graph.no-palette": "未找到调色板",
  "color-graph.paint-graph": "绘制图形",
  "color-graph.palette": "调色板",
  "color-graph.palette-index": "调色板索引",
  "color-graph.radial-gradient": "径向渐变",
  "color-graph.refresh": "刷新",
  "color-graph.solid": "纯色",
  "color-graph.source-paint": "源绘制",
  "color-graph.sweep-gradient": "扫描渐变",
  "color-graph.title": "颜色图形",
  "color-graph.transform": "变换",
  "color-graph.unknown": "未知",
  "color-layers.add-kf-at-current-location": "在当前轴位置添加关键帧",
  "color-layers.add-layer": "添加颜色图层",
  "color-layers.add-stop": "添加停止点",
  "color-layers.alpha": "透明度",
  "color-layers.angle-turns": "角度（圈）",
  "color-layers.centerX": "centerX",
  "color-layers.centerY": "centerY",
  "color-layers.color-index": "Color Index",
  "color-layers.color-stops": "颜色停止点",
  "color-layers.colrv1-header": "COLRv1",
  "color-layers.convert-to-v1": "→ COLRv1",
  "color-layers.convert-v0-to-v1": "将 COLRv0 转换为 COLRv1",
  "color-layers.edit-colrv1-paint": "编辑 COLRv1 绘制",
  "color-layers.edit-description": "编辑颜色图层映射",
  "color-layers.end-angle": "结束角 °",
  "color-layers.fill-paint-type": "填充绘制类型",
  "color-layers.glyph": "字形",
  "color-layers.no-glyph-selected": "选择字形以分配颜色图层",
  "color-layers.no-layers-yet": "尚未定义颜色图层",
  "color-layers.no-palette": "字体中未定义调色板",
  "color-layers.no-stops-yet": "尚无停止点",
  "color-layers.paint-type": "绘制类型",
  "color-layers.r0": "r0",
  "color-layers.r1": "r1",
  "color-layers.remove-layer": "删除",
  "color-layers.remove-stop": "删除停止点",
  "color-layers.start-angle": "起始角 °",
  "color-layers.start-v0": "开始 COLRv0",
  "color-layers.start-v1": "开始 COLRv1",
  "color-layers.stop": "停止",
  "color-layers.stop-offset": "停止偏移",
  "color-layers.title": "颜色图层",
  "color-layers.transformed-glyph": "变换字形",
  "color-layers.x0": "x0",
  "color-layers.x1": "x1",
  "color-layers.x2": "x2",
  "color-layers.y0": "y0",
  "color-layers.y1": "y1",
  "color-layers.y2": "y2",
  "color-palettes.add-color": "+ 添加颜色",
  "color-palettes.add-palette": "添加调色板",
  "color-palettes.color-index-tooltip": "颜色索引 %0",
  "color-palettes.edit-description": "编辑调色板",
  "color-palettes.entries-count-plural": "条目",
  "color-palettes.entries-count-single": "条目",
  "color-palettes.palette-entry-count": "%0 个条目",
  "color-palettes.palette-label": "调色板 %0",
  "color-palettes.palette-name-label": "调色板名称",
  "color-palettes.palette-name-notice":
    "调色板名称目前仅支持 fontra 源 / COLRv1 编译。若在 UFO 源中添加，当前 UFO/fontmake 路径尚不支持保留/导出。",
  "color-palettes.palette-name-placeholder": "可选调色板名称",
  "color-palettes.remove-palette": "删除调色板",
  "color-palettes.title": "调色板",
  "color-panel.add-keyframe": "在当前轴位置添加关键帧",
  "color-panel.add-keyframe-short": "+",
  "color-panel.make-variable": "在轴上设为可变",
  "color-panel.make-variable-short": "⬦",
  "color-panel.remove-keyframe": "删除此关键帧",
  "color-panel.remove-keyframe-short": "×",
  "color-panel.remove-variable": "删除变体并恢复为静态值",
  ...
  "editor.paint-tool-unified": "绘制工具",
