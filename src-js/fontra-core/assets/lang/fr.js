...
export const strings = {
  ...
  "action.add-paint": "Ajouter un paint",
  "action.add-paint.no-v1-layers.message":
    "Ce glyphe n'a pas encore de calques COLRv1. Utilisez le bouton « v1 » dans le panneau Calques de couleur pour initialiser le graphe de peinture d'abord.",
  "action.add-paint.no-v1-layers.title": "Pas de graphe de peinture COLRv1",
  ...
  "action.export-as.woff2": "Police web (*.woff2)",
  ...
  "color-graph.add-paint-layers":
    "Ajoutez des couches de peinture dans le panneau Couches de couleur",
  "color-graph.alpha": "Alpha",
  "color-graph.backdrop-paint": "Peinture de fond",
  "color-graph.color-stops": "Arrêts de couleur",
  "color-graph.composite": "Composite",
  "color-graph.composite-mode": "Mode composite",
  "color-graph.glyph": "Glyphe",
  "color-graph.layers": "Couches",
  "color-graph.linear-gradient": "Dégradé linéaire",
  "color-graph.no-glyph-selected": "Aucun glyphe sélectionné",
  "color-graph.no-paint-data": "Aucune donnée de peinture COLRv1",
  "color-graph.no-palette": "Aucune palette de couleurs trouvée",
  "color-graph.paint-graph": "Graphique de peinture",
  "color-graph.palette": "Palette",
  "color-graph.palette-index": "Index de palette",
  "color-graph.radial-gradient": "Dégradé radial",
  "color-graph.refresh": "Actualiser",
  "color-graph.solid": "Solide",
  "color-graph.source-paint": "Peinture source",
  "color-graph.sweep-gradient": "Dégradé balayage",
  "color-graph.title": "Graphique de couleur",
  "color-graph.transform": "Transformation",
  "color-graph.unknown": "Inconnu",
  "color-layers.add-kf-at-current-location":
    "Ajouter un keyframe à la position actuelle de l'axe",
  "color-layers.add-layer": "Ajouter un calque de couleur",
  "color-layers.add-stop": "Ajouter un arrêt",
  "color-layers.alpha": "Alpha",
  "color-layers.angle-turns": "Angle (tours)",
  "color-layers.centerX": "centerX",
  "color-layers.centerY": "centerY",
  "color-layers.color-index": "Color Index",
  "color-layers.color-stops": "Points d'arrêt de couleur",
  "color-layers.colrv1-header": "COLRv1",
  "color-layers.convert-to-v1": "→ COLRv1",
  "color-layers.convert-v0-to-v1": "Convertir COLRv0 → COLRv1",
  "color-layers.edit-colrv1-paint": "Modifier la peinture COLRv1",
  "color-layers.edit-description": "Modifier le mappage des calques de couleur",
  "color-layers.end-angle": "Angle de fin °",
  "color-layers.fill-paint-type": "Type de peinture de remplissage",
  "color-layers.glyph": "Glyphe",
  "color-layers.no-glyph-selected":
    "Sélectionnez un glyphe pour attribuer des calques de couleur",
  "color-layers.no-layers-yet": "Aucun calque de couleur défini pour l'instant",
  "color-layers.no-palette": "Aucune palette de couleurs définie dans la police",
  "color-layers.no-stops-yet": "Aucun arrêt pour l'instant",
  "color-layers.paint-type": "Type de peinture",
  "color-layers.r0": "r0",
  "color-layers.r1": "r1",
  "color-layers.remove-layer": "Supprimer",
  "color-layers.remove-stop": "Supprimer l'arrêt",
  "color-layers.start-angle": "Angle de départ °",
  "color-layers.start-v0": "Démarrer COLRv0",
  "color-layers.start-v1": "Démarrer COLRv1",
  "color-layers.stop": "Arrêt",
  "color-layers.stop-offset": "Décalage d'arrêt",
  "color-layers.title": "Calques de couleur",
  "color-layers.transformed-glyph": "Glyphe transformé",
  "color-layers.x0": "x0",
  "color-layers.x1": "x1",
  "color-layers.x2": "x2",
  "color-layers.y0": "y0",
  "color-layers.y1": "y1",
  "color-layers.y2": "y2",
  "color-palettes.add-color": "+ Ajouter une couleur",
  "color-palettes.add-palette": "Ajouter une palette",
  "color-palettes.color-index-tooltip": "Index de couleur %0",
  "color-palettes.edit-description": "Modifier les palettes de couleurs",
  "color-palettes.entries-count-plural": "entrées",
  "color-palettes.entries-count-single": "entrée",
  "color-palettes.palette-entry-count": "%0 entrées",
  "color-palettes.palette-label": "Palette %0",
  "color-palettes.palette-name-label": "Nom de la palette",
  "color-palettes.palette-name-notice":
    "Les noms de palette sont actuellement pris en charge uniquement pour la source fontra / compilation COLRv1. Ajoutés dans une source UFO, ils ne sont pas encore conservés/exportés par le chemin UFO/fontmake actuel.",
  "color-palettes.palette-name-placeholder": "Nom de palette optionnel",
  "color-palettes.remove-palette": "Supprimer la palette",
  "color-palettes.title": "Palettes de couleurs",
  "color-panel.add-keyframe": "Ajouter un keyframe à la position actuelle de l'axe",
  "color-panel.add-keyframe-short": "+",
  "color-panel.make-variable": "Rendre variable sur l'axe",
  "color-panel.make-variable-short": "⬦",
  "color-panel.remove-keyframe": "Supprimer ce keyframe",
  "color-panel.remove-keyframe-short": "×",
  "color-panel.remove-variable":
    "Supprimer la variation et revenir à la valeur statique",
  ...
  "editor.paint-tool-unified": "Outil Peinture",
  ...
  "sidebar.color-graph": "Graphique de couleur",
  "sidebar.color-layers": "Calques de couleur",
  "sidebar.color-layers.title": "Calques de couleur",
