...
export const strings = {
  ...
  "action.add-paint": "Add Paint",
  "action.add-paint.no-v1-layers.message":
    'This glyph has no COLRv1 layers yet. Use the "v1" button in the Color Layers panel to initialize the paint graph first.',
  "action.add-paint.no-v1-layers.title": "No COLRv1 Paint Graph",
  ...
  "color-graph.add-paint-layers": "Add paint layers in the Color Layers panel",
  "color-graph.alpha": "Alpha",
  "color-graph.backdrop-paint": "Backdrop Paint",
  "color-graph.color-stops": "Color Stops",
  "color-graph.composite": "Composite",
  "color-graph.composite-mode": "Composite Mode",
  "color-graph.glyph": "Glyph",
  "color-graph.layers": "Layers",
  "color-graph.linear-gradient": "Linear Gradient",
  "color-graph.no-glyph-selected": "No glyph selected",
  "color-graph.no-paint-data": "No COLRv1 paint data",
  "color-graph.no-palette": "No color palette found",
  "color-graph.paint-graph": "Paint Graph",
  "color-graph.palette": "Palette",
  "color-graph.palette-index": "Palette Index",
  "color-graph.radial-gradient": "Radial Gradient",
  "color-graph.refresh": "Refresh",
  "color-graph.solid": "Solid",
  "color-graph.source-paint": "Source Paint",
  "color-graph.sweep-gradient": "Sweep Gradient",
  "color-graph.title": "Color Graph",
  "color-graph.transform": "Transform",
  "color-graph.unknown": "Unknown",
  "color-layers.add-kf-at-current-location": "Add keyframe at current axis location",
  ...
  "color-layers.color-stops": "Color Stops",
  "color-layers.colrv1-header": "COLRv1",
  "color-layers.convert-to-v1": "→ COLRv1",
  "color-layers.convert-v0-to-v1": "Convert COLRv0 → COLRv1",
  ...
  "color-layers.no-palette": "No color palette defined in font",
  "color-layers.no-stops-yet": "No stops yet",
  "color-layers.paint-type": "Paint Type",
  "color-layers.r0": "r0",
  "color-layers.r1": "r1",
  ...
  "color-layers.transformed-glyph": "Transformed Glyph",
  "color-layers.x0": "x0",
  "color-layers.x1": "x1",
  "color-layers.x2": "x2",
  "color-layers.y0": "y0",
  "color-layers.y1": "y1",
  "color-layers.y2": "y2",
  "color-palettes.add-color": "+ Add Color",
  "color-palettes.add-palette": "Add Palette",
  "color-palettes.color-index-tooltip": "Color index %0",
  "color-palettes.edit-description": "Edit color palettes",
  "color-palettes.entries-count-plural": "entries",
  "color-palettes.entries-count-single": "entry",
  "color-palettes.palette-entry-count": "%0 entries",
  "color-palettes.palette-label": "Palette %0",
  "color-palettes.palette-name-label": "Palette name",
  "color-palettes.palette-name-notice":
    "Palette names are currently supported for fontra source / COLRv1 compile only. If added in UFO source, they are not yet preserved/exported by the current UFO/fontmake path.",
  "color-palettes.palette-name-placeholder": "Optional palette name",
  "color-palettes.remove-palette": "Remove Palette",
  "color-palettes.title": "Color Palettes",
  "color-panel.add-keyframe": "Add keyframe at current axis location",
  "color-panel.add-keyframe-short": "+",
  "color-panel.make-variable": "Make variable on axis",
  ...
  "editor.paint-tool-unified": "Paint Tool",
