...
export const strings = {
  ...
  "action.export-as.woff2": "Weblettertype (*.woff2)",
  ...
  "color-graph.add-paint-layers": "Voeg verflagen toe in het paneel Kleurenlagen",
  "color-graph.alpha": "Alfa",
  "color-graph.backdrop-paint": "Achtergrondverf",
  "color-graph.color-stops": "Kleurstops",
  "color-graph.composite": "Composiet",
  "color-graph.composite-mode": "Composietmodus",
  "color-graph.glyph": "Glyph",
  "color-graph.layers": "Lagen",
  "color-graph.linear-gradient": "Lineair verloop",
  "color-graph.no-glyph-selected": "Geen glyph geselecteerd",
  "color-graph.no-paint-data": "Geen COLRv1-verfgegevens",
  "color-graph.no-palette": "Geen kleurenpalet gevonden",
  "color-graph.paint-graph": "Verfgraph",
  "color-graph.palette": "Palet",
  "color-graph.palette-index": "Paletindex",
  "color-graph.radial-gradient": "Radiaal verloop",
  "color-graph.refresh": "Vernieuwen",
  "color-graph.solid": "Effen",
  "color-graph.source-paint": "Bronverf",
  "color-graph.sweep-gradient": "Sweep-verloop",
  "color-graph.title": "Kleurengraph",
  "color-graph.transform": "Transformatie",
  "color-graph.unknown": "Onbekend",
  "color-layers.add-kf-at-current-location": "Keyframe toevoegen op huidige aspositie",
  "color-layers.add-layer": "Kleurlaag toevoegen",
  "color-layers.add-stop": "Stop toevoegen",
  "color-layers.alpha": "Alpha",
  "color-layers.angle-turns": "Hoek (omwentelingen)",
  "color-layers.centerX": "centerX",
  "color-layers.centerY": "centerY",
  "color-layers.color-index": "Color Index",
  "color-layers.color-stops": "Kleurstops",
  "color-layers.colrv1-header": "COLRv1",
  "color-layers.convert-to-v1": "→ COLRv1",
  "color-layers.convert-v0-to-v1": "COLRv0 → COLRv1 converteren",
  "color-layers.edit-colrv1-paint": "COLRv1-verf bewerken",
  "color-layers.edit-description": "Kleurlaagmapping bewerken",
  "color-layers.end-angle": "Eindhoek °",
  "color-layers.fill-paint-type": "Opvulverftype",
  "color-layers.glyph": "Glyph",
  "color-layers.no-glyph-selected": "Selecteer een glyph om kleurlagen toe te wijzen",
  "color-layers.no-layers-yet": "Nog geen kleurlagen gedefinieerd",
  "color-layers.no-palette": "Geen kleurenpalet gedefinieerd in lettertype",
  "color-layers.no-stops-yet": "Nog geen stops",
  "color-layers.paint-type": "Verftype",
  "color-layers.r0": "r0",
  "color-layers.r1": "r1",
  "color-layers.remove-layer": "Verwijderen",
  "color-layers.remove-stop": "Stop verwijderen",
  "color-layers.start-angle": "Starthoek °",
  ...
  "color-layers.title": "Kleurlagen",
  "color-layers.transformed-glyph": "Getransformeerde glyph",
  "color-layers.x0": "x0",
  "color-layers.x1": "x1",
  "color-layers.x2": "x2",
  "color-layers.y0": "y0",
  "color-layers.y1": "y1",
  "color-layers.y2": "y2",
  "color-palettes.add-color": "+ Kleur toevoegen",
  "color-palettes.add-palette": "Palet toevoegen",
  "color-palettes.color-index-tooltip": "Kleurindex %0",
  "color-palettes.edit-description": "Kleurpaletten bewerken",
  "color-palettes.entries-count-plural": "vermeldingen",
  "color-palettes.entries-count-single": "vermelding",
  "color-palettes.palette-entry-count": "%0 vermeldingen",
  "color-palettes.palette-label": "Palet %0",
  "color-palettes.palette-name-label": "Palet naam",
  "color-palettes.palette-name-notice":
    "Paletnamen worden momenteel alleen ondersteund voor fontra-bron / COLRv1-compilatie. Indien toegevoegd in UFO-bron, worden ze nog niet bewaard/geëxporteerd via het huidige UFO/fontmake-pad.",
  "color-palettes.palette-name-placeholder": "Optionele paletnaam",
  "color-palettes.remove-palette": "Palet verwijderen",
  "color-palettes.title": "Kleurpaletten",
  "color-panel.add-keyframe": "Keyframe toevoegen op huidige aspositie",
  "color-panel.add-keyframe-short": "+",
  "color-panel.make-variable": "Variabel maken op as",
  "color-panel.make-variable-short": "⬦",
  "color-panel.remove-keyframe": "Dit keyframe verwijderen",
  "color-panel.remove-keyframe-short": "×",
  "color-panel.remove-variable":
    "Variatie verwijderen en terugkeren naar statische waarde",
  ...
  "editor.paint-tool-unified": "Verfgereedschap",
