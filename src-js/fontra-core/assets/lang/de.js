...
export const strings = {
  ...
  "action.export-as.woff2": "Webschrift (*.woff2)",
  ...
  "color-graph.add-paint-layers": "Fügen Sie Farbebenen im Farbebenen-Panel hinzu",
  "color-graph.alpha": "Alpha",
  "color-graph.backdrop-paint": "Hintergrund-Farbe",
  "color-graph.color-stops": "Farbstopps",
  "color-graph.composite": "Komposit",
  "color-graph.composite-mode": "Kompositmodus",
  "color-graph.glyph": "Glyph",
  "color-graph.layers": "Ebenen",
  "color-graph.linear-gradient": "Linearer Verlauf",
  "color-graph.no-glyph-selected": "Kein Glyph ausgewählt",
  "color-graph.no-paint-data": "Keine COLRv1-Farbdaten",
  "color-graph.no-palette": "Keine Farbpalette gefunden",
  "color-graph.paint-graph": "Farbauftragsgraph",
  "color-graph.palette": "Palette",
  "color-graph.palette-index": "Palettenindex",
  "color-graph.radial-gradient": "Radialer Verlauf",
  "color-graph.refresh": "Aktualisieren",
  "color-graph.solid": "Einfarbig",
  "color-graph.source-paint": "Quell-Farbe",
  "color-graph.sweep-gradient": "Sweep-Verlauf",
  "color-graph.title": "Farbgraph",
  "color-graph.transform": "Transformieren",
  "color-graph.unknown": "Unbekannt",
  "color-layers.add-kf-at-current-location":
    "Keyframe an der aktuellen Achsenposition hinzufügen",
  "color-layers.add-layer": "Farbebene hinzufügen",
  "color-layers.add-stop": "Stopp hinzufügen",
  "color-layers.alpha": "Alpha",
  "color-layers.angle-turns": "Winkel (Umdrehungen)",
  "color-layers.centerX": "centerX",
  "color-layers.centerY": "centerY",
  "color-layers.color-index": "Color Index",
  "color-layers.color-stops": "Farbstopps",
  "color-layers.colrv1-header": "COLRv1",
  "color-layers.convert-to-v1": "→ COLRv1",
  "color-layers.convert-v0-to-v1": "COLRv0 → COLRv1 konvertieren",
  "color-layers.edit-colrv1-paint": "COLRv1-Malerei bearbeiten",
  "color-layers.edit-description": "Farbebenen-Zuordnung bearbeiten",
  "color-layers.end-angle": "Endwinkel °",
  "color-layers.fill-paint-type": "Füllmaltyp",
  "color-layers.glyph": "Glyph",
  "color-layers.no-glyph-selected":
    "Wählen Sie ein Glyph aus, um Farbebenen zuzuweisen",
  "color-layers.no-layers-yet": "Noch keine Farbebenen definiert",
  "color-layers.no-palette": "Keine Farbpalette in der Schriftart definiert",
  "color-layers.no-stops-yet": "Noch keine Stopps",
  "color-layers.paint-type": "Maltyp",
  "color-layers.r0": "r0",
  "color-layers.r1": "r1",
  "color-layers.remove-layer": "Entfernen",
  "color-layers.remove-stop": "Stopp entfernen",
  "color-layers.start-angle": "Startwinkel °",
  "color-layers.start-v0": "COLRv0 starten",
  "color-layers.start-v1": "COLRv1 starten",
  "color-layers.stop": "Stopp",
  "color-layers.stop-offset": "Stopp-Versatz",
  "color-layers.title": "Farbebenen",
  "color-layers.transformed-glyph": "Transformiertes Glyph",
  "color-layers.x0": "x0",
  "color-layers.x1": "x1",
  "color-layers.x2": "x2",
  "color-layers.y0": "y0",
  "color-layers.y1": "y1",
  "color-layers.y2": "y2",
  "color-palettes.add-color": "+ Farbe hinzufügen",
  "color-palettes.add-palette": "Palette hinzufügen",
  "color-palettes.color-index-tooltip": "Farbindex %0",
  "color-palettes.edit-description": "Farbpaletten bearbeiten",
  "color-palettes.entries-count-plural": "Einträge",
  "color-palettes.entries-count-single": "Eintrag",
  "color-palettes.palette-entry-count": "%0 Einträge",
  "color-palettes.palette-label": "Palette %0",
  "color-palettes.palette-name-label": "Palettenname",
  "color-palettes.palette-name-notice":
    "Palettennamen werden derzeit nur für Fontra-Quelle / COLRv1-Kompilierung unterstützt. Bei UFO-Quellen werden sie vom aktuellen UFO/fontmake-Pfad noch nicht gespeichert/exportiert.",
  "color-palettes.palette-name-placeholder": "Optionaler Palettenname",
  "color-palettes.remove-palette": "Palette entfernen",
  "color-palettes.title": "Farbpaletten",
  "color-panel.add-keyframe": "Keyframe an der aktuellen Achsenposition hinzufügen",
  "color-panel.add-keyframe-short": "+",
  "color-panel.make-variable": "Auf der Achse variabel machen",
  "color-panel.make-variable-short": "⬦",
  "color-panel.remove-keyframe": "Dieses Keyframe entfernen",
  "color-panel.remove-keyframe-short": "×",
  "color-panel.remove-variable":
    "Variation entfernen und statischen Wert wiederherstellen",
  ...
  "editor.paint-tool-unified": "Malwerkzeug",
